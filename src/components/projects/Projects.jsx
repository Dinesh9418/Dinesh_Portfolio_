...
const Projects = [
    {
        id: 1,
        project_name: "MCA (Ministry of Corporate Affairs)",
        role: "React Developer",
        technologies: "HTML, CSS, JavaScript, ReactJS, Bootstrap",
        yearsActive: "Jul 2022 - Present",
        description: [
    ...
    {
        id: 2,
        project_name: "Profile Sketch",
        role: "web Developer",
        echnologies: "HTML, CSS, JavaScript, ReactJS",
        yearsActive: "Dec 2021 - Jun 2022",
        description: [
    ...
    //     project_name: "MCA (Ministry of Corporate Affairs)",
    //     role: "React Developer",
    //     echnologies: "HTML, CSS, JavaScript, ReactJS, Bootstrap",
    //     yearsActive: "Jul 2022 - Present",
    //     description: [
    //         "The MCA Corporate Compliance Portal is a web-based application designed to simplify compliance filing and tracking for corporate users. It enables companies to submit statutory forms online, validate entries, and monitor submission status, reducing manual paperwork and improving efficiency."
    //     ],
